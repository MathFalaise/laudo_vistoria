"""Alias de compatibilidade: o módulo real é core/image_utils.py.

O motor foi para o pacote `core` em 25/09/2026, na evolução para aplicação
web. Este arquivo existe para que `import image_utils` continue funcionando nos
...
from core import image_utils as _modulo_real
