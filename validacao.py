"""Alias de compatibilidade: o módulo real é core/validacao.py.

O motor foi para o pacote `core` em 25/09/2026, na evolução para aplicação
web. Este arquivo existe para que `import validacao` continue funcionando nos
...
from core import validacao as _modulo_real
