"""Alias de compatibilidade: o módulo real é core/config.py.

O motor foi para o pacote `core` em 25/09/2026, na evolução para aplicação
web. Este arquivo existe para que `import config` continue funcionando nos
...
from core import config as _modulo_real
