"""Alias de compatibilidade: o módulo real é core/gemini_client.py.

O motor foi para o pacote `core` em 25/09/2026, na evolução para aplicação
web. Este arquivo existe para que `import gemini_client` continue funcionando nos
...
from core import gemini_client as _modulo_real
